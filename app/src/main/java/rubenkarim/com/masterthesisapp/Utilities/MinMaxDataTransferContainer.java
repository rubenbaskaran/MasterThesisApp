...
public class MinMaxDataTransferContainer implements Serializable {
    ...
    public MinMaxDataTransferContainer(ImageView leftEye, ImageView rightEye, ImageView nose, ImageView cameraPreviewContainer) {
